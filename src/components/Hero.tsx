    ...
    <section className="relative pt-32 pb-16 bg-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-5 text-center lg:text-left pl-4 lg:pl-[50px]">
            ...
            <div className="pt-2 flex justify-center lg:justify-start">
              <a 
                href="#proposal-form" 
                className="btn-yellow text-xl px-8 py-3 rounded-xl shadow-lg"
              >
          ...
          <div className="lg:col-span-5 relative flex flex-col items-center justify-center">
            ...
            <div className="relative w-full max-w-sm aspect-[4/5] flex items-center justify-center">
              ...
              <div className="absolute inset-2 bg-sociallyin-blue rounded-[40%_60%_70%_30%/40%_50%_60%_50%] shadow-xl" />
        ...
        <div className="mt-12 pt-6 border-t border-gray-200">
          <div className="flex items-center justify-center gap-8 flex-wrap opacity-75 font-gothic text-2xl font-normal tracking-widest text-gray-700">
